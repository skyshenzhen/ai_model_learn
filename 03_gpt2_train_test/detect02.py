...
# -------------------------------------------------------------------------------
# Name:         detect02.py
# Description:  This is a script for generating poetry using GPT-2 model.（postprocessing effects）
# Author:       shaver
# Date:         2025/5/12
# -------------------------------------------------------------------------------
...
model_path = r"/Users/shaver/PycharmProjects/ai_model_learn/03_gpt2_train_test/model/models--uer--gpt2-chinese-cluecorpussmall/snapshots/c2c0249d8a2731f269414cc3b22dff021f8e07a3"  # 预训练模型路径
